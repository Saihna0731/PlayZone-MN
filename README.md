# My Map App - Game Center Management System

Монгол улсын Game center болон тоглоомын төвүүдийг удирдах вэб аппликейшн.

## 🚀 Онцлогууд

- 🗺️ **Интерактив газрын зураг** - Leaflet ашиглан бодит цагийн газрын зураг
- 🎮 **Game Center удирдлага** - Төвүүдийг бүртгэх, засах, устгах
...
git clone https://github.com/Saihna0731/my-map-app.git
cd my-map-app
...
# server/.env дээр MongoDB URI болон JWT secret тохируулах
...
**🔍 Дэлгэрэнгүй:** [SETUP_GUIDE.md](./SETUP_GUIDE.md) үзнэ үү
